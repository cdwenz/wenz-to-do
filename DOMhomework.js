...
// Tu código acá:
document.querySelector('#createdBy').innerHTML += ' Cristian';
...
function buildToDo(todo, index) {
  ...
  return toDoShell; //<div className='toDoShell'><span id='index'>description</span></div>
}
...
function buildToDos(toDos) {  //[{description: 'primero', complete: false}]
  // Tu código acá:
let array = [];
if(toDos === []) return array;
...
function addToDo() {
  ...
  if(document.querySelector('input').value !== '') {
    var newToDo = new ToDo(document.querySelector('input').value)
